...
class GridGraph:
    ...
    def __init__(self, file_path=None, width=-1, height=-1, origin=(0, 0),
        ...
        # Node data for search (initialized properly in init_graph).
        self.visited = None
        self.parent = None
    ...
    def get_parent(self, cell):
        ...
        return self.parent[cell.j][cell.i]
    ...
    def init_graph(self):
        ...
        # Reset visited cells for visualization.
        self.visited_cells = []

        # 2D array of booleans to track visited cells
        self.visited = np.zeros((self.height, self.width), dtype=bool)

        # 2D array of parents: each entry will store a Cell or None
        self.parent = [[None for _ in range(self.width)] for _ in range(self.height)]

    def find_neighbors(self, i, j):
        """Returns a list of the neighbors of the given cell.
        This should not include any cells outside of the bounds of the graph."""
        nbrs = []
